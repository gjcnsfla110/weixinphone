...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const popupClose = (i) => {
      common_vendor.index.__f__("log", "at components/listDetail/bottom.vue:53", i);
      if (i === 1) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        f: common_vendor.sr(popupCart, "f5b744ea-1", {
          "k": "popupCart"
        }),
        g: common_vendor.p({
          type: "bottom"
        ...
        j: common_vendor.sr(popupBuy, "f5b744ea-3", {
          "k": "popupBuy"
        }),
        k: common_vendor.p({
          type: "bottom"
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-f5b744ea"]]);
wx.createComponent(Component);
//# sourceMappingURL=../../../.sourcemap/mp-weixin/components/listDetail/bottom.js.map
